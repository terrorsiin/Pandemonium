...
public static void main(String[] args) {
      ...
      //while (count < 30) {
         Document doc = null;
         //ArrayList mnetRankList = null ; 
         try {
            out = new BufferedWriter(new FileWriter("mnet.txt",true));
            //mnetRankList = new ArrayList();
            ...
            System.out.println(mnetRankList[0] + "|" + mnetRankList[1] + "|" + mnetRankList[2] + "|" + mnetRankList[3] + "\n");
            
            out.write(mnetRankList[0] + "|" + mnetRankList[1] + "|" + mnetRankList[2] + "|" + mnetRankList[3] + "\n");
            out.flush();
            }
            /*try {
               Thread.sleep(60000);
